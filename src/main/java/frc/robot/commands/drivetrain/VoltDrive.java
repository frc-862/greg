...
public class VoltDrive extends CommandBase {
    ...
    public VoltDrive(LightningDrivetrain drivetrain, DoubleSupplier left, DoubleSupplier right, DoubleSupplier speedMult) {
    ...
    public void execute() {
        ...
        double leftVolts = filter.filter(speedMult.getAsDouble() * left.getAsDouble());
        double rightVolts = filter.filter(speedMult.getAsDouble() * right.getAsDouble());
    ...
    public void end(boolean interrupted) {
        ...
        // Shuffleboard.getTab("demo").addPersistent(title, defaultValue)
    }
