...
//        adjuster.configReverseLimitSwitchSource(LimitSwitchSource.FeedbackConnector, LimitSwitchNormal.NormallyClosed, 10);
        ...
        //encoder config
        adjuster.configSelectedFeedbackSensor(FeedbackDevice.Analog, Constants.kPIDLoopIdx, Constants.kTimeoutMs);
        ...
        Shuffleboard.getTab("Shooter").addNumber("Shooter Min Limit", getMin());        
        Shuffleboard.getTab("Shooter").addNumber("Shooter Max Limit", getMax());
        Shuffleboard.getTab("Shooter").addNumber("Shooter Current RAW", adjuster::getSelectedSensorPosition);
