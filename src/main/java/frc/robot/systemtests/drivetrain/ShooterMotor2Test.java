...
public class ShooterMotor2Test extends AbstractTimedSystemTest {
    private static final double testLength = 1.0;
    private double startPosition;
    private Shooter shooter;
    private int tolerance = 5; 

    public ShooterMotor2Test(Shooter shooter) {
    ...
    public boolean didPass() {
        return shooter.getFlywheelMotor2Velocity() >= 2000 - tolerance;
    }
